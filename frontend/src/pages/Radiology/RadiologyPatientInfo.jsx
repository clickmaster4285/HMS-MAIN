...
import { formatCurrency, calculateAge, formatDate } from './utils'; // Utility functions
import PrintRadiologyReport from './PrintRadiologyReport';
import ReactDOMServer from 'react-dom/server';

const RadiologyPatientInfo = ({ currentReport, selectedReport, handlePrint }) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-700">
              ...
              {currentReport?.deleted ? 'Deleted' : selectedReport?.paymentStatus || 'Active'}
            </p>
          </div>
          <div className="space-y-2">
            <p className="text-gray-700">
            ...
            <p className="text-gray-700">
              <span className="font-medium text-teal-600">Advance Payment:</span>{' '}
