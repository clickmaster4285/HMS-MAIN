...
const PrintTestReport = ({ patientTest, testDefinitions }) => {
  ...
  // Get current system date and time in Pakistani timezone (24-hour format)
  const getCurrentDateTime = () => {
    ...
    const options = {
      ...
      hour: '2-digit',
      minute: '2-digit',
      hour12: false, // Ensures 24-hour format: 14:30 instead of 2:30 PM
    };
      ...
      <table style={styles.patientInfoTable}>
        <tbody>
          ...
          <tr>
            ...
            <td style={styles.valueCell}>{getCurrentDateTime()}</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  // Render a single test with patient info (for separate page tests)
  ...
  // Render grouped tests page (up to 2 tests per page)
...
const styles = {
  ...
  testNameCell: { width: '40%', wordWrap: 'break-word' },
  resultCell: { width: '20%', wordWrap: 'break-word' },
  unitCell: { width: '15%', wordWrap: 'break-word' },
  rangeCell: { width: '25%', wordWrap: 'break-word', whiteSpace: 'normal' },
